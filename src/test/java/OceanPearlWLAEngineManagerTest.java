...
public class OceanPearlWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(OceanPearlWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/OceanPearlWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/OceanPearlWLAIW/InitOutcome.xml").getDocumentElement();
